...
<body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
    ...
    <aside
        ...
        <div class="h-19.5">
            ...
            <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
                <img src="<?= base_url() ?>assets/img/logo-ct.png"
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidebar grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors hover:bg-slate-50"
                        href="<?= base_url() ?>">
                        <div
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors"
                        ...
                        <div
                            class="bg-gradient-to-tl from-sky-700 to-indigo-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                ...
                <li class="mt-0.5 w-full">
                    <div
                        class="py-2.7 ease-nav-brand my-0 mx-4 items-center whitespace-nowrap px-4 text-center text-xs">
                        <script>
                        let date = new Date();
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        <!-- Navbar -->
        <nav class="relative flex flex-wrap items-center justify-between px-6 py-2 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start"
            ...
            <div class="flex flex-row">
                ...
                <div class="">
                    <div class="flex flex-row items-center gap-2">
                        ...
                        <h2 class="font-bold"><?= $session->get('user_name'); ?></h2>
                    </div>
                    <div class="flex flex-row items-center gap-2">
                        <p class="text-slate-400">Email:</p></p>
