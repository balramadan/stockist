    ...
    <div class="flex flex-1 flex-col justify-center space-y-5 max-w-md">
        ...
        <form action="<?= base_url() ?>regadmin/save" method="post">
            <div class="flex flex-col max-w-md space-y-3 mb-3">
                ...
                <input type="text" name="name" id="InputForName" class="form-control bg-white text-slate-500 placeholder:text-slate-800 flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal" value="<?= set_value('name') ?>">
            </div>
            <div class="flex flex-col max-w-md space-y-3 mb-3">
                <label for="InputForEmail" class="form-label">Email address</label>
                <input type="email" name="email" class="form-control bg-white text-slate-500 placeholder:text-slate-800 flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal" id="InputForEmail" value="<?= set_value('email') ?>">
            </div>
            <div class="flex flex-col max-w-md space-y-3 mb-3">
                <label for="InputForPassword" class="form-label">Password</label>
                <input type="password" name="password" class="form-control bg-white text-slate-500 placeholder:text-slate-800 flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal" id="InputForPassword">
            </div>
            <div class="flex flex-col max-w-md space-y-3 mb-3">
                <label for="InputForConfPassword" class="form-label">Confirm Password</label>
                <input type="password" name="confirm-password" class="form-control bg-white text-slate-500 placeholder:text-slate-800 flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal" id="InputForConfPassword">
            </div>
