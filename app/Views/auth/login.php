    ...
    <div class="flex flex-1 flex-col justify-center space-y-5 max-w-md">
        ...
        <form action="<?= base_url() ?>login/auth" method="post">
            <div class="flex flex-col max-w-md space-y-3 mb-3">
                ...
                <input type="email" name="email" id="InputForEmail" class="form-control flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal" value="<?= set_value('email'); ?>">
            </div>
            <div class="flex flex-col max-w-md space-y-3 mb-3">
