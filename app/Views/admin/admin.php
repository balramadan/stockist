...
<body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" href="<?= base_url() ?>admin">
                        <div class="bg-gradient-to-tl from-sky-700 to-indigo-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path fill="white" d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12c5.16-1.26 9-6.45 9-12V5zm0 4a3 3 0 0 1 3 3a3 3 0 0 1-3 3a3 3 0 0 1-3-3a3 3 0 0 1 3-3m5.13 12A9.7 9.7 0 0 1 12 20.92A9.7 9.7 0 0 1 6.87 17c-.34-.5-.63-1-.87-1.53c0-1.65 2.71-3 6-3s6 1.32 6 3c-.24.53-.53 1.03-.87 1.53" />
                            </svg>
                        </div>
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <!-- Main Code -->
        <div class="overflow-x-auto px-10 py-2">
            <table class="table">
                <!-- head -->
                <thead>
                    <tr>
                        <th>
                            <label>
                                <input type="checkbox" class="checkbox bg-slate-100" />
                            </label>
                        </th>
                        <th>Nama</th>
                        <th>Email</th>
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="avatar">
                                        <div class="mask mask-squircle w-12 h-12">
                                            <img src="https://api.dicebear.com/8.x/initials/svg?seed=<?= $dataAdmin['name']; ?>" alt="avatar">
                                        </div>
                                    </div>
                                    <div>
                                        <p class="font-bold"><?= $dataAdmin['name'] ?></p>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <p class=""><?= $dataAdmin['email'] ?></p>
                            </td>
                            <td>
                                <p class=""><?= $dataAdmin['job'] ?></p>
                            </td>
                            <td>
                                <p><?= $dataAdmin['created_at']; ?></p>
                            </td>
                            <th>
