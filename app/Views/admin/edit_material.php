...
<body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <div x-cloak class="relative flex flex-col w-full bg-transparent pointer-events-auto px-10 py-2">
            <form action="<?= base_url('bahan/up')?>" method="post">
                <div class="relative flex-auto">
                    <div class="flex flex-col">
                        <label for="inputNamaBahan">Nama Bahan</label>
                        <input type="text" name="bahan" id="inputNamaBahan" value="<?= $result['nm'] ?>" class="py-2 px-3 bg-white text-black">
                    </div>
                </div>
                <div class="relative flex-auto">
                    <div class="flex flex-col">
                        <label for="inputJumlahBahan">Jumlah Bahan</label>
                        <input type="number" name="amount" id="inputJumlahBahan" value="<?= $result['amount'] ?>" class="py-2 px-3 bg-white text-black">
                    </div>
                </div>
                <div class="relative flex-auto">
                    <div class="flex flex-col">
                        <label for="inputKategoriBahan">Asal Pemasok</label>
                        <input type="text" name="supplier" id="inputKategoriBahan" value="<?= $result['ns'] ?>" class="py-2 px-3 bg-white text-black">
                    </div>
                </div>
